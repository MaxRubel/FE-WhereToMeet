...
export default function EventPage() {
    ...
    const [isViewing, setIsViewing] = useState(eventId ? "ViewSingleEvent" : "ViewEvents");
    ...
    return (
        <div className="profile-page-layout">
            ...
            <div className="profile-main-form">
                ...
                {isViewing == "ViewSingleEvent" && <ViewSingleEvent eventId={eventId} setIsViewing={setIsViewing} />}
            </div>
        </div>
